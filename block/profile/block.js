(function (blocks, editor, components, i18n, element) {
    ...
    registerBlockType('better/profile-block', { // The name of our block. Must be a string with prefix. Example: my-plugin/my-custom-block.
      ...
      edit: function (props) {
        ...
        return [
          ...
          el('div', { className: props.className },
            el('div', {
              className: attributes.mediaID ? 'better-profile-image image-active' : 'better-profile-image image-inactive',
            ...
            el('div', { className: 'better-profile-content', style: { textAlign: alignment } },
              ...
              el('div', { className: 'better-profile-social' },
      ...
      save: function (props) {
        ...
        return (
          el('div', { className: props.className },
            attributes.mediaURL && el('div', { className: 'better-profile-image', style: { backgroundImage: 'url(' + attributes.mediaURL + ')' } },
